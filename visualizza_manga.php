    ...
    <script>
            ...
            for (let status of ordineStatus) {
                if (attivitàPerStatus[status].length > 0) {
                    ...
                    for (let attivitàItem of attivitàPerStatus[status]) {
                        ...
                        let descrizione = "<strong>" + attivitàItem.titolo + "</strong><br>" +
                            "Capitoli letti: " + attivitàItem.capitoli_letti + 
                            " | Volumi: " + attivitàItem.volumi_letti +
                            "<br>Anno: " + attivitàItem.anno + " - Formato: " + attivitàItem.formato;
        ...
        function toggleEditor(dati) {
            ...
            if (dati) {
                ...
                if (dati.capitoli_letti) {
                    document.getElementById('capitoli_letti').value = dati.capitoli_letti;
                } else {
                    document.getElementById('capitoli_letti').value = "";
                }

                if (dati.volumi_letti) {
                    document.getElementById('volumi_letti').value = dati.volumi_letti;
                } else {
                    document.getElementById('volumi_letti').value = "";
                }
                ...
                if (dati.rereading) {
                    document.getElementById('rereading').value = dati.rereading;
                } else {
                    document.getElementById('rereading').value = "0";
                }
        ...
        async function salvaAttivita() {
            ...
            url += "&manga_id=" + document.querySelector('#contenuto').dataset.riferimentoApi;
            url += "&status=" + document.getElementById('status').value;
            url += "&punteggio=" + document.getElementById('punteggio').value;
            url += "&capitoli_letti=" + document.getElementById('capitoli_letti').value;
            url += "&volumi_letti=" + document.getElementById('volumi_letti').value;
            ...
            url += "&rereading=" + document.getElementById('rereading').value;
